...
public class Main {
        public static void main(String[] args) {
                ...
                List<Double> c = new ArrayList<>(Arrays.asList(2.0, 3.0, 4.0)); // A vector of coefficients of the
                                                                                // objective
                                                                                // function
                ...
                List<Double> b = new ArrayList<>(Arrays.asList(10.0, 15.0, 8.0)); // A vector of right-hand sides of
                                                                                  // constraints
                double eps = 0.0001;
                double alpha1 = 0.5;
                double alpha2 = 0.9;
                ...
                // Interior point method for alpha1
                ...
                System.out
                                .println("x* by Interior-Point algorithm (alpha = 0.5): "
                                                + InteriorPointMethod.formatList(xInterior1));
                System.out.println(
                                "Maximum value of the objective function (alpha = 0.5): "
                                                + String.format("%.4f", objInterior1));

                // Interior point method for alpha2
                ...
                System.out
                                .println("x* by Interior-Point algorithm (alpha = 0.9): "
                                                + InteriorPointMethod.formatList(xInterior2));
                System.out.println(
                                "Maximum value of the objective function (alpha = 0.9): "
                                                + String.format("%.4f", objInterior2));
        }
}